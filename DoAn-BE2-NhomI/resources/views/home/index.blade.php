...
@section('content')
    ...
    {{-- ==================== 1. SẢN PHẨM TRENDING (Từ nhánh Trung) ==================== --}}
                        ...
                        <div class="snap-start shrink-0 w-[85vw] md:w-[calc(33.333%-0.67rem)] lg:w-[calc(25%-0.75rem)]">
                            <a href="{{ url('/product/' . $product->product_id) }}" class="flex h-full w-full">
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/20 hover:border-white/30 transition-all duration-300 flex flex-col flex-1 group h-full w-full">
                                    ...
                                    <div class="mb-4">
                                        <p class="text-orange-400 font-black text-lg">{{ number_format($product->base_price, 0, ',', '.') }}₫</p>
                                    </div>
                                    <div class="flex gap-2">
                                        <button class="flex-1 bg-gradient-to-r from-orange-500 to-red-500 text-white text-[10px] font-black py-2.5 rounded uppercase tracking-wider">Mua ngay</button>
    ...
    {{-- ==================== 2. SẢN PHẨM MỚI (Từ nhánh Master) ==================== --}}
                ...
                <div class="group bg-white rounded-2xl p-4 border border-slate-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
                    ...
                    <div class="flex items-center justify-between mt-auto pt-4 border-t border-slate-50">
                        ...
                        <form action="{{ route('cart.add') }}" method="POST">
                            ...
                            <button type="submit" class="w-10 h-10 bg-slate-50 text-brand-blue rounded-xl flex items-center justify-center hover:bg-brand-blue hover:text-white transition-all">
