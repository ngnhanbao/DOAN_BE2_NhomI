                ...
                <div class="glass-card rounded-[32px] p-8 fade-slide">
                    ...
                    <form action="{{ route('checkout.store') }}" method="POST">
                        ...
                        <div class="space-y-5">
                            ...
                            {{-- COD --}}
                            <label class="payment-card active rounded-[28px] p-6 flex justify-between items-center"
                                id="cod_card">
                                ...
                                <input checked type="radio" name="payment_method" value="cod" onchange="changePayment()">
...
@endif
       ...
       {{ $total > 50000000 ? 'disabled' : '' }}>
                            ...
                            {{-- VNPAY --}}
                            <label class="payment-card rounded-[28px] p-6 flex justify-between items-center"
                                id="vnpay_card">
                                ...
                                <input type="radio" name="payment_method" value="vnpay" onchange="changePayment()">
            ...
            <div class="lg:col-span-4">
                ...
                <div class="glass-card order-summary rounded-[32px] p-5 sticky top-24 fade-slide overflow-hidden">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div
                            class="w-14 h-14 rounded-2xl bg-blue-50 flex items-center justify-center text-2xl flex-shrink-0">
                            🛒
                        </div>
                                ...
                                <div class="flex gap-4 items-center">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center justify-between gap-2 mt-4 flex-wrap">
                                            ...
                                            <span
                                                class="bg-gray-100 text-gray-500 text-sm px-3 py-1 rounded-full flex-shrink-0">
                                                x{{ $item['quantity'] }}
                                            </span>
