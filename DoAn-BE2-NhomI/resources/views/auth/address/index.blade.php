...
@section('content')
                        ...
                        @forelse($addresses as $address)
                            ...
                            : 'Địa chỉ phụ'
                                                ...
                                                <div class="flex gap-4 items-center">
                                                    ...
                                                    {{-- delete --}}
                                                    <form id="deleteForm{{ $address->address_id }}"
                                                        action="{{ route('addresses.destroy', $address->address_id) }}" method="POST">

                                                        @csrf
                                                        @method('DELETE')

                                                        <button type="button" onclick="openDeleteModal({{ $address->address_id }})"
                                                    ...
                                                    @if(!$address->is_default)
                                                        ...
                                                        <form id="defaultForm{{ $address->address_id }}"
                                                            action="{{ route('addresses.default', $address->address_id) }}" method="POST"
                                                            class="ml-auto">

                                                            @csrf

                                                            <button type="button" onclick="openDefaultModal({{ $address->address_id }})"
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
        ...
        <div class="bg-white rounded-3xl p-8 w-[90%] max-w-md text-center">
            ...
            <div class="w-20 h-20 rounded-full bg-red-100 mx-auto flex items-center justify-center mb-5">
    ...
    {{-- DEFAULT MODAL --}}
    {{-- ===================================================== --}}
    <div id="defaultModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">

        <div class="bg-white rounded-3xl p-8 w-[90%] max-w-md text-center">

            <div class="w-20 h-20 rounded-full bg-blue-100 mx-auto flex items-center justify-center mb-5">
            ...
            <div class="flex justify-center gap-3 mt-8">
                ...
                <button onclick="toggleModal('defaultModal')"
                    class="px-6 py-3 rounded-2xl border border-gray-300 hover:bg-gray-100 transition">
                ...
                <button onclick="submitDefaultForm()"
    ...
    @if(session('success') || session('error'))
        ...
        <div id="messageModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            ...
            <div class="bg-white rounded-3xl p-8 w-[90%] max-w-md text-center">
                ...
                <button onclick="closeModal('messageModal')" class="mt-8 text-white px-8 py-3 rounded-2xl font-bold transition
