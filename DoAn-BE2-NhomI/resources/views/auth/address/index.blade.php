        ...
        <aside class="lg:col-span-3">
            ...
            <div class="bg-slate-50 rounded-2xl py-8 overflow-hidden">
                ...
                <div class="px-8 mb-6">
                    ...
                    <h2
                        class="text-blue-900 text-sm font-bold uppercase tracking-widest">
            ...
            <div class="bg-white rounded-3xl shadow-sm p-8 md:p-12">
                ...
                <div
                    ...
                    <div>
                        ...
                        <h1
                            class="text-4xl font-black tracking-tight text-blue-900 mb-2">
                    ...
                    @forelse($addresses as $address)
                        ...
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                {{-- full name --}}
                                <h3
                                    class="text-xl font-bold text-blue-900 mb-1">
                                ...
                                {{-- address --}}
                                <div
                                    class="space-y-1 text-gray-600 text-sm mb-8 leading-relaxed">
